                    ...
                    <tbody>
                        @foreach ($payments as $item)
                            <tr>
                                ...
                                <td>{{ $item->amount}}</td>
                                <td>
                                    <a href="{{url('/payments/'. $item->id)}}" title="View payment"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i>View
                                    </button></a>
                                    <a href="{{url('/payments/'. $item->id . '/edit')}}" title="Edit payment"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit
                                    </button></a>
                                    ...
                                    <a href="{{url('/report/report1/'. $item->id)}}" title="Edit payment"><button class="btn btn-success btn-sm"><i class="fa fa-print" aria-hidden="true"></i>Print
                                    </button></a>
                                </td>
                            </tr>
                        @endforeach
